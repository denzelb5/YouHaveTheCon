...
INSERT INTO Convention (ConName, ConStartDate, LocationInfo)
VALUES ('DragonCon', '2021-05-21T10:00:00', 'Dallas Convention Center')

alter table Convention alter column ConStartDate Date;

INSERT INTO Convention (ConName, ConStartDate, LocationInfo, LocationName)
...
update Convention set LocationInfo = '445 Atlanta S. Pkwy Atlanta, GA 30349' where ConName = 'DragonCon';
update Convention set LocationName = 'Dragon Con Inc.' where ConName = 'DragonCon'
